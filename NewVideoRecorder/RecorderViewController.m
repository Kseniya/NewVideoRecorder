...
@interface RecorderViewController () <UIGestureRecognizerDelegate>
@end

@interface RecorderViewController (InternalMethods) <UIGestureRecognizerDelegate>
...
@interface RecorderViewController (CaptureManagerDelegate) <CaptureManagerDelegate>
@end
...
@implementation RecorderViewController (InternalMethods)
...
@implementation RecorderViewController (CaptureManagerDelegate)
